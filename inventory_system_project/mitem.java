...
class mitem extends JInternalFrame implements ActionListener
{
...
l2=new JLabel("Purchase Rate");
l3=new JLabel("Sale Rate");
l4=new JLabel("Opening Quantity In Hand");
l5=new JLabel("Closing Quantity In Hand");
...
String str1="Select itemname from mitem";
...
if( a!="" && !t2.getText().equals("") && !t3.getText().equals("") &&!t4.getText().equals("") &&!t5.getText().equals(""))
{
String str="INSERT INTO mitem values('"+a+"',"+b+","+c+","+d+","+e1+")";
...
String str="SELECT * FROM mitem WHERE itemname='"+x+"'";
Statement s=con.createStatement();
ResultSet r=s.executeQuery(str);
if(r.next())
{
t1.setText(r.getString(1));
t2.setText(String.valueOf(r.getInt(2)));
t3.setText(String.valueOf(r.getInt(3)));
...
if( a!="" && !t2.getText().equals("") && !t3.getText().equals("") &&!t4.getText().equals("") &&!t5.getText().equals(""))
{
String str="Update mitem set prate=" +b+ ",srate=" +c+ ",opqty=" +d+",clqty="+e1+" WHERE itemname='"+a+"'";
Statement s=con.createStatement();
int r=s.executeUpdate(str);
b3.setEnabled(false);
b4.setEnabled(false);
...
{
String a=t1.getText();
String str="delete from mitem WHERE itemname='"+a+"'";
Statement s=con.createStatement();
int r=s.executeUpdate(str);
co.removeItem(a);
