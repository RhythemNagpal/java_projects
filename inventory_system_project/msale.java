...
class msale extends JInternalFrame implements ActionListener
{
...
l6=new JLabel("Sale Party DETAILS");
...
String str1="Select partyname from msale";
...
{
String str="INSERT INTO msale values('"+a+"','"+b+"','"+c+"',"+d+","+d+")";
...
String str="SELECT * FROM msale WHERE partyname='"+x+"'";
Statement s=con.createStatement();
...
if(a!="" && b!="" && c!="" && !t4.getText().equals(""))
{
String str="Update msale set addre='" +b+ "',phone='" +c+ "',opbal=" +d+",clbal="+d+" WHERE partyname='"+a+"'";
Statement s=con.createStatement();
int r=s.executeUpdate(str);
b3.setEnabled(false);
b4.setEnabled(false);
...
{
String a=t1.getText();
String str="delete from msale WHERE partyname='"+a+"'";
Statement s=con.createStatement();
int r=s.executeUpdate(str);
co.removeItem(a);
