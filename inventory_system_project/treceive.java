...
class treceive extends JInternalFrame implements ActionListener,ItemListener
{
...
String str2="Select * from treceive";
...
{
ss=1;
String str1="Select * from treceive";
Statement s1=con.createStatement();
...
//{
String str2="INSERT INTO treceive values("+a+",'"+b+"','"+c+"',"+d+","+e1+",'"+f+"')";
Statement s2=con.createStatement();
int r2=s2.executeUpdate(str2);
amt=e1;
String str3="update msale set clbal=clbal+"+e1+" where partyname='"+c+"'";
...
ss=0;
String str2="SELECT * FROM treceive WHERE partyname='"+c1+"'";
Statement s2=con.createStatement();
...
int ss=0;
String str1="SELECT * FROM treceive WHERE partyname='"+c+"'";
Statement s1=con.createStatement();
...
int e1=Integer.parseInt(t5.getText());
String f=t6.getText();
String str="update treceive set amt="+e1+" where partyname='"+c+"'";
