...
class tpurchase extends JInternalFrame implements ActionListener,ItemListener,FocusListener,ListSelectionListener
{
...
l7=new JLabel("Rate");
l8=new JLabel("Quantity Available");
l9=new JLabel("Quantity purchased");
...
he=new JLabel("Purchase Transaction");
...
{
ss=1;
String str1="Select * from billmaster";
Statement s1=con.createStatement();
...
{
int e1=c2*d2;
String str2="INSERT INTO billtrans values("+a2+",'"+b2+"',"+c2+","+d2+","+e1+")";
Statement s2=con.createStatement();
int r2=s2.executeUpdate(str2);
amt=e1;
String str="INSERT INTO billmaster values("+a+",'"+b+"','"+c+"','"+d+"',"+amt+")";
...
Statement s2=con.createStatement();
int r2=s2.executeUpdate(str2);
String str="update billmaster set total="+amt;
Statement s=con.createStatement();
int r=s.executeUpdate(str);
String d=String.valueOf(co1.getSelectedItem());
String str3="update mpurchase set clbal=clbal+"+e1+" where partyname='"+d+"'";
...
int ss=0;
String str1="SELECT * FROM billmaster WHERE billno="+a;
Statement s1=con.createStatement();
ResultSet rr=s1.executeQuery(str1);
while(rr.next())
{
...
String str="SELECT * FROM billmaster WHERE billno="+a;
Statement s=con.createStatement();
...
str="SELECT * FROM billtrans WHERE billno="+a;
